...
Then, you need a repository for you game. You can either wait for us to create one, or use [our template on Github](https://github.com/gamepark/board-along-history) to [create a new repository](https://docs.github.com/fr/repositories/creating-and-managing-repositories/creating-a-repository-from-a-template)
...
Once you have one Material type and one Location type, you can start to setup a new game in [AlongHistoryRules.ts](/rules/src/AlongHistoryRules.ts)
